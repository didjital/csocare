...
public class HarianAct extends ListActivity {

	// All static variables
	static final String URL = "http://csoc.or.id/icsoc/pengurus/tampil_pengurus.php";
	// XML node keys
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.harian_act);
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// Starting new intent
				Intent in = new Intent(getApplicationContext(), HarianSingle.class);
